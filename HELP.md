...
* The original package name 'com.fever.event.test.fever-demo-miguelcabezas' is invalid and this project uses 'com.fever.event.test.fever_demo_miguelcabezas' instead.
